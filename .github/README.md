...
[`@aws-sdk/client-appflow`](https://www.npmjs.com/package/@aws-sdk/client-appflow/v/3.583.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-appflow@3.583.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-E+r0+h9UzqpfMSXygyrZ6TB5pzzXkdJ++RaPo228N2OHbCguIfRUnSzVTaClbzEx
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-appflow": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-appflow@3.583.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-appflow@3.583.0/index.min.mjs": "sha384-E+r0+h9UzqpfMSXygyrZ6TB5pzzXkdJ++RaPo228N2OHbCguIfRUnSzVTaClbzEx"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-appflow/blob/refs/tags/3.583.0/LICENSE
```
