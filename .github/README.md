...
[`@aws-sdk/client-appflow`](https://www.npmjs.com/package/@aws-sdk/client-appflow/v/3.359.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-appflow@3.359.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-EJflKU/OmXbGmiNudd+MiWzyr1lXBnnkr/lyq6vS7ACKWp1XjQQO+7BWl0XTF4on
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-appflow": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-appflow@3.359.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-appflow@3.359.0/index.min.mjs": "sha384-EJflKU/OmXbGmiNudd+MiWzyr1lXBnnkr/lyq6vS7ACKWp1XjQQO+7BWl0XTF4on"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-appflow/blob/refs/tags/3.359.0/LICENSE
```
